from spectrl.ars.rl import get_rollout, test_policy
...
def ars(env, nn_policy, params):
    ...
    for i in range(params.n_iters):
        ...
        # Step 3h: Logging
        (exp_cum_reward, success_rate) = test_policy(env, nn_policy, 10)
        current_time = time.time() - start_time
        print('Steps taken after iteration {}: {}'.format(i, num_steps))
