from sarl.envs.rooms import GridParams
...
MAX_TIMESTEPS.append(250)
FINAL_ROOM.append((1, 2))
OBSTACLES.append([(12, 12), (16, 16)])
RANDOM_STATES.append(15)
RANDOM_EDGES.append(10)
...
FINAL_ROOM.append((1, 0))
OBSTACLES.append(None)
RANDOM_STATES.append(7)
RANDOM_EDGES.append(3)
...
FINAL_ROOM.append((1, 2))
OBSTACLES.append([(12, 12), (16, 16)])
RANDOM_STATES.append(20)
RANDOM_EDGES.append(7)
...
GRID_PARAMS_LIST.append(GridParams(size4, edges4, room_size1, wall_size1,
                                   vertical_door1, horizontal_door1))
MAX_TIMESTEPS.append(350)
FINAL_ROOM.append((2, 3))
OBSTACLES.append(None)
RANDOM_STATES.append(25)
RANDOM_EDGES.append(10)
