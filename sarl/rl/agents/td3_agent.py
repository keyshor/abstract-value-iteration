...
from sarl.rl.agents import gaussian_policy
...
class Td3Agent(tf_agent.TFAgent):
    ...
    def __init__(self,
        ...
        collect_policy = gaussian_policy.GaussianPolicy(
            collect_policy,
            scale=exploration_noise_std,
            exploration_decay=noise_decay,
            clip=True)
    ...
    def critic_loss(self, time_steps, actions, next_time_steps, weights=None):
        ...
        with tf.name_scope('critic_loss'):
            ...
            target_q_input_1 = (next_time_steps.observation,
                                noisy_target_actions)
            target_q_values_1, _ = self._target_critic_network_1(
                target_q_input_1,
                next_time_steps.step_type)
            target_q_input_2 = (next_time_steps.observation,
                                noisy_target_actions)
