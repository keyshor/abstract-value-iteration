...
from environments import rooms_util
...
def get_evaluate_checkpoint_fn(master, output_dir, eval_step_fns,
                               ...
                               generate_summaries, video_settings, success_fn=None,
                               is_ant_env=True):
      ...
      if generate_summaries:
        ...
        (average_reward, last_reward,
         ...
         states, actions) = eval_utils.compute_average_reward(
             ...
             num_episodes_eval, success_fn=success_fn, is_ant_env=is_ant_env)
...
def evaluate(checkpoint_dir,
  ...
  is_ant_env = True
  if rooms_env > -1:
    success_fn = rooms_util.get_success_fn(rooms_env)
    is_ant_env = False
  ...
  evaluate_checkpoint_fn = get_evaluate_checkpoint_fn(
      ...
      generate_videos, generate_summaries, video_settings, success_fn=success_fn,
      is_ant_env=is_ant_env)
